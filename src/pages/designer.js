      ...
      <div className={styles.page__designer}>
        ...
        */}
        ...
        <section className={styles.hello}>
          <p>
            I work for a tech startup in Stockholm, Sweden called Ombori; I
            create delightful UI’s for our products, champion design thinking,
            and consult for our clients.
          </p>
        ...
        <section className={styles.services}>
          ...
          <ul className={styles.services__list}>
            <li>
              ...
              <p>
                I create and implement design systems and processes. Including
                Sketch and web UI Kits; implementation of Design Processes and
                workflows; and detailed component documentation.
              </p>
            ...
            <li>
              ...
              <p>
                Originally conceived by Jake Knapp at Google Ventures, Design
                Sprints are a great way to answer big questions and solve real
                problems quickly and efficiently. From idea to prototype in one
                week. I run design sprints all over the World with the team at
                Ombori.
              </p>
